 ...
 * <P>
 * Copyright (c) 2008, 2009, 2010 Boxbe, Inc., and Les Hazlewood. See license, below.
 *
 ...
 * results.
 * <P>
 * This class has been successfully used on a few  billion real-world addresses, live in
 ...
 * EmailAddressParser) would return the decoded version of the text, if any was needed. If you need the
 * decoded form, you can do something like this (where ia is the InternetAddress object returned
 * from an EmailAddressParser method):
 * <P>
...
public class EmailAddressParser
{
     ...
     */
    private static boolean isValidReturnPath(String email)
    {
     ...
     * string)
     */
    private static String getReturnPathBracketContents(String email)
    {
     ...
     */
    private static String getReturnPathAddress(String email)
    {
        if (email == null) return(null);
