 ...
 */
private[backchat] trait NotNullStrings {
...
private[backchat] object NotNullStrings extends NotNullStrings
...
trait SpecificationBase extends Specification with NoTimeConversions with NotNullStrings {
